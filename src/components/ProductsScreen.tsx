...
export default function ProductsScreen({ permissions }: ProductsScreenProps) {
  ...
  const handleNumberInput = (val: string) => {
    return val.replace(/[^0-9٠-٩.-]/g, '').replace(/[٠-٩]/g, d => '٠١٢٣٤٥٦٧٨٩'.indexOf(d).toString());
  };
                  ...
                  />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setProductForm({ ...productForm, purchasePrice: handleNumberInput(e.target.value) })}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setProductForm({ ...productForm, sellingPrice: handleNumberInput(e.target.value) })}
