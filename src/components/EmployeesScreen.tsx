...
const PERMISSION_CATEGORIES = [
  ...
  { 
    ...
    customActions: [
      ...
      { key: 'showProfitMargin', label: 'إظهار هامش الربح' }
    ]
  },
  { 
    key: 'invoices', 
  ...
  { key: 'workersManagement', label: 'إدارة العمال', icon: '👷‍♂️' },
  { key: 'moneyTransfers', label: 'الحوالات والصيرفات', icon: '💸' }
];
...
const DEFAULT_PERMISSIONS = () => {
  ...
  PERMISSION_CATEGORIES.forEach(cat => {
    perms[cat.key] = { view: false, create: false, edit: false, delete: false, approve: false, export: false, viewWidget: false, showProfitMargin: false };
  });
  return perms;
};
